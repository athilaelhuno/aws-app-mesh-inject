...
func init() {
	...
	flag.StringVar(&cfg.SidecarImage, "sidecar-image", "111345817488.dkr.ecr.us-east-1.amazonaws.com/aws-appmesh-envoy:v1.11.1.0-prod", "Envoy sidecar container image.")
	...
	flag.StringVar(&cfg.InitImage, "init-image", "059588584554.dkr.ecr.us-east-1.amazonaws.com/aws-appmesh-proxy-route-manager:v2", "Init container image.")
